...
export const enSimpleNoArgs = {
  ...
  proxyEnabled: 'SOCKS5 Proxy',
  proxyHost: 'Host',
  proxyHostPlaceholder: 'localhost or 127.0.0.1',
  proxyPort: 'Port',
  ...
  proxyTestSuccess: 'Proxy Test Success',
  proxyTestSuccessDescription: 'Successfully connected through the proxy server.',
  proxyValidationError: 'Proxy Validation Error',
  proxyValidationErrorHost: 'Proxy host is required.',
  proxyValidationErrorPort: 'Proxy port must be between 1 and 65535.',
